...
class _BodyState extends State<Body> {
 ...
 String ip = "https://smtdriver.com";
  ...
  Future<dynamic>fetchUserRegisterCode(String agentUser, String agentEmail, String agentSecurityCode, String agentPassword, String agentPassword2) async {
    ...
    //api register
    http.Response responses = await http.post(Uri.encodeFull('$ip/api/register'), body: data);
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            RoundedButton(
                text: "REGISTRARME",
                press: () {
                  fetchUserRegisterCode(user.text, userEmail.text, userCode.text, userPassword1.text, userPassword2.text);
                }),
