            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  // Botón para aceptar la llamada y navegar a JitsiCallPage
                  FloatingActionButton(
                    onPressed: () {
                      Navigator.of(context).pop();
                      if (PushNotificationServices.navigatorKey?.currentState != null) {
                        PushNotificationServices.navigatorKey!.currentState!.push(
                          MaterialPageRoute(
                            builder: (context) => JitsiCallPage(roomId: roomId, name: callerName),
                          ),
                        );
                      }
                    },
